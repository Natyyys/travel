...
var _toggle = require("./modules/header-menu/toggle");
var _videoplayer = require("./modules/hero/videoplayer");
var _audioplayer = require("./modules/hero/audioplayer");
var _heroSlider = require("./modules/hero/hero-slider");
var _toursSlider = require("./modules/tours/tours-slider");
var _coachesSlider = require("./modules/coaches/coaches-slider");
var _reviewsSlider = require("./modules/reviews/reviews-slider");
var _featuresSlider = require("./modules/features/features-slider");
var _gallerySlider = require("./modules/gallery/gallery-slider");
var _requiredForm = require("./modules/required-form");
// ---------------------------------
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  (0, _audioplayer.initAudioPlayer)();
  (0, _heroSlider.initSwiperHero)();
  (0, _toursSlider.initToursSlider)();
  (0, _coachesSlider.initCoachesSlider)();
  (0, _reviewsSlider.initReviewsSlider)();
  (0, _featuresSlider.initFeaturesSlider)();
  (0, _featuresSlider.handleResize)();
...
},{"./modules/coaches/coaches-slider":2,"./modules/features/features-slider":3,"./modules/form-validate/form":5,"./modules/gallery/gallery-slider":11,"./modules/header-menu/toggle":12,"./modules/hero/audioplayer":13,"./modules/hero/hero-slider":14,"./modules/hero/videoplayer":15,"./modules/required-form":16,"./modules/reviews/reviews-slider":17,"./modules/tours/tours-slider":18,"./utils/ios-vh-fix":20}],2:[function(require,module,exports){
"use strict";
...
var coachesSlider = document.querySelector('[data-coaches-slider]');
var buttonNext = document.querySelector('[data-coaches-prev]');
var buttonPrev = document.querySelector('[data-coaches-next]');
var initCoachesSlider = exports.initCoachesSlider = function initCoachesSlider() {
  var swiper = new _swiper.default(coachesSlider, {
    loop: false,
    navigation: {
      nextEl: buttonNext,
      prevEl: buttonPrev
...
},{"../../vendor/swiper":22}],3:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.initFeaturesSlider = exports.handleResize = void 0;
var _swiper = _interopRequireDefault(require("../../vendor/swiper"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
var featuresSlider = document.querySelector('[data-features-slider]');
var buttonNext = document.querySelector('[data-features-prev]');
var buttonPrev = document.querySelector('[data-features-next]');
var featuresSwiper;
var initFeaturesSlider = exports.initFeaturesSlider = function initFeaturesSlider() {
  if (featuresSlider && window.innerWidth > 1199) {
    featuresSwiper = new _swiper.default(featuresSlider, {
      loop: true,
      navigation: {
        nextEl: buttonNext,
        prevEl: buttonPrev
...
},{"../../vendor/swiper":22}],4:[function(require,module,exports){
"use strict";
...
var _swiper = _interopRequireDefault(require("../../vendor/swiper"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
var gallerySlider = document.querySelector('[data-gallery-slider]');
var buttonNext = document.querySelector('[data-gallery-prev]');
var buttonPrev = document.querySelector('[data-gallery-next]');
var initGallerySlider = exports.initGallerySlider = function initGallerySlider() {
  var swiper = new _swiper.default(gallerySlider, {
    loop: true,
    navigation: {
      nextEl: buttonNext,
      prevEl: buttonPrev
...
},{"../../vendor/swiper":22}],12:[function(require,module,exports){
"use strict";
...
var addToggleMenu = exports.addToggleMenu = function addToggleMenu() {
  ...
  var root = document.querySelector('[data-header="data-header"]');
  var container = root.querySelector('[data-container="header-wrapper"]');
  var toggle = root.querySelector('[data-toggle="toggle-menu"]');
  var nav = root.querySelector('[data-menu="menu-nav"]');
  ...
  var onLinkClick = function onLinkClick(evt) {
    return evt.target.matches('[data-link="link-menu"]') ? closeMenu() : null;
  };
  var isMenu = function isMenu(evt) {
    return evt.target.closest('[data-header="data-header"]') && evt.target.closest('[data-toggle="toggle-menu"]') || evt.target.closest('[data-menu="menu-nav"]') ? evt.preventDefault() : closeMenu();
  };
  function openMenu() {
...
},{"../../utils/scroll-lock":21}],13:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.showAudioCover = exports.showAudioButton = exports.initAudioPlayer = exports.createAudio = void 0;
var container = document.querySelector('[data-audio-wrapper]');
var link = document.querySelector('[data-audio-link]');
var button = document.querySelector('[data-audio-button]');
var cover = document.querySelector('[data-audio-poster]');
var showAudioButton = exports.showAudioButton = function showAudioButton() {
  button.style.display = 'block';
};
var showAudioCover = exports.showAudioCover = function showAudioCover() {
  cover.style.display = 'block';
};
var createAudio = exports.createAudio = function createAudio(element) {
...
var initAudioPlayer = exports.initAudioPlayer = function initAudioPlayer() {
    ...
    on: {
      slideChange: function slideChange() {
        if (document.querySelector('.video__wrapper iframe')) {
          ...
          (0, _videoplayer.showButton)();
          (0, _videoplayer.showCover)();
        }
        if (document.querySelector('.audio-wrapper iframe')) {
          document.querySelector('.audio-wrapper iframe').remove();
          (0, _audioplayer.showAudioButton)();
          (0, _audioplayer.showAudioCover)();
        }
      }
    }
  });
...
},{"../../vendor/swiper":22,"./audioplayer":13,"./videoplayer":15}],15:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.showCover = exports.showButton = exports.initVideoPlayer = exports.createVideo = void 0;
var video = document.querySelector('[data-video]');
var link = document.querySelector('[data-video-link]');
var button = document.querySelector('[data-video-button]');
var cover = document.querySelector('[data-video-poster]');
var showButton = exports.showButton = function showButton() {
  button.style.display = 'block';
};
var showCover = exports.showCover = function showCover() {
  cover.style.display = 'block';
};
var createVideo = exports.createVideo = function createVideo(element) {
  if (document.querySelector('.video__wrapper iframe')) {
    document.querySelector('.video__wrapper iframe').remove();
  }
  var iframe = document.createElement('iframe');
...
exports.requiredInput = void 0;
var phone = document.querySelector('[data-input-phone]');
var email = document.querySelector('[data-input-email]');
var phoneInput = phone.querySelector('input');
var emailInput = email.querySelector('input');
var CLASS_VALID = 'is-valid';
var addAttrRequired = function addAttrRequired(el) {
  el.setAttribute('data-required', 'data-required');
};
var removesAttrRequired = function removesAttrRequired(el) {
...
var requiredInput = exports.requiredInput = function requiredInput() {
  initForm();
...
var buttonNext = document.querySelector('[data-reviews-prev]');
var buttonPrev = document.querySelector('[data-reviews-next]');
var initReviewsSlider = exports.initReviewsSlider = function initReviewsSlider() {
  var swiper = new _swiper.default(reviewsSlider, {
    loop: true,
    navigation: {
      nextEl: buttonNext,
      prevEl: buttonPrev
...
var _swiper = _interopRequireDefault(require("../../vendor/swiper"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
var toursSlider = document.querySelector('[data-tours-slider]');
var buttonNext = document.querySelector('[data-tours-prev]');
var buttonPrev = document.querySelector('[data-tours-next]');
function setToursSlider() {
  return new _swiper.default(toursSlider, {
    navigation: {
      nextEl: buttonNext,
      prevEl: buttonPrev
    },
